...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#edf1fb] text-[#222741]">
      <div className="pointer-events-none fixed left-0 top-0 h-96 w-96 rounded-full bg-[#d9ddff] blur-3xl animate-float-slow" />
      <div className="pointer-events-none fixed bottom-0 right-0 h-96 w-96 rounded-full bg-[#f1dcff] blur-3xl animate-float-slow delay-300" />

      <header className="sticky top-0 z-20 border-b border-white/70 bg-white/45 backdrop-blur-xl animate-fade-in-down">
      ...
      <main className="relative z-10">
        <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24 animate-fade-in-up">
          <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="rounded-3xl border border-white/70 bg-white/65 p-5 shadow-[0_20px_50px_rgba(84,95,170,0.2)] backdrop-blur-xl animate-fade-in-up delay-200 hover-lift">
        ...
        <section className="px-4 pb-16 sm:px-6 lg:px-8 animate-fade-in-up delay-300">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {features.map((feature) => {
                ...
                return (
                  <article key={feature.title} className="rounded-2xl border border-white/70 bg-white/65 p-5 backdrop-blur-xl hover-lift">
